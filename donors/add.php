...
if (isset($_POST['submit'])) {
	if ($_POST['submit'] == 'Add Doner') {
		...
		if ($Count >0) {
			echo "This is email already exists";
		}
		else{
			$Query = "INSERT INTO donors (Name,Email,Phone,Location,BloodGroup,LastDonated) VALUES('$Name','$Email','$Phone','$Location','$BloodGroup','$LastDonated')";
			$Result = mysqli_query($Connection,$Query);

			if (!$Result) {
				echo "Something error ! in Query Execution";
			}
			else{
				echo "Doner add create successfully";
			}
		}
...
<html lang="en">
	...
	<body>
		<div class="container ">
			<!-- form section -->
			<form  action="index.php?page=doneradd" method="POST" enctype="multipart/form-data" class="form-custom">
				<div class="row ">
					<div class="col-md-8 m-auto">
						<!-- heading start -->
						<h3 class="text-center p-4">Doner Add </h3>
						<!-- heading end -->
						<!-- single item -->
						...
						<div class="form-row form-group">
							...
							<div class="col-md-4">
							  <input type="date" name="LastDonated"class="form-control" placeholder="Email">
							</div>
						...
						<input type="submit" name="submit" value="Add Doner" class="btn-custom offset-5">
					</div>
				</div>
